...
-(void)viewWillAppear:(BOOL)animated {
    ...
    webInfoArray = [[NSMutableArray alloc]initWithArray:[AppManager sharedInstance].favorites];
...
- (void)tableView:(UITableView *)tableView moveRowAtIndexPath:(NSIndexPath *)fromIndexPath toIndexPath:(NSIndexPath *)toIndexPath
{
    ...
    if (fromIndexPath!=toIndexPath) {
        ...
        [[AppManager sharedInstance].favorites removeObject:dict];
        [[AppManager sharedInstance].favorites insertObject:dict atIndex:toIndexPath.row];
...
- (void)searchBar:(UISearchBar *)searchBar textDidChange:(NSString *)searchText {
    ...
    webInfoArray =[[NSMutableArray alloc]initWithArray:[[AppManager sharedInstance].favorites filteredArrayUsingPredicate:[NSPredicate predicateWithFormat:@"name contains[cd]%@",searchText]]];
    [tblFavorites reloadData];
